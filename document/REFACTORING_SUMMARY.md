...
### 3. **Handler Registry**
```python
from fastapi_payloadshield import register_handler, get_handler
...
```python
from fastapi_payloadshield import EncryptionHandler, register_handler
...
### Modified Files
1. **`fastapi_payloadshield/crypto.py`**
...
2. **`fastapi_payloadshield/decorators.py`**
...
3. **`fastapi_payloadshield/__init__.py`**
